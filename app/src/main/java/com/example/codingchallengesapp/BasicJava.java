...
public class BasicJava extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.java_basic);  // Layout file with 5 test cards
        ...
        db.collection("questions")
                ...
                .addOnSuccessListener(queryDocumentSnapshots -> {
                    if (!queryDocumentSnapshots.isEmpty()) {
                        ...
                        Intent intent = new Intent(BasicJava.this, TestLive.class);
                ...
                .addOnFailureListener(e ->
                        Toast.makeText(BasicJava.this, "Error loading question: " + e.getMessage(), Toast.LENGTH_LONG).show()
                );
    }
}
