...
public class ModeratePython extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.python_moderate);  // Layout file with 5 test cards
    ...
    private void fetchQuestion(int testNumber) {
        ...
        db.collection("questions")
                ...
                .whereArrayContains("language", "Python") // Corrected language filter
                .get()
                .addOnSuccessListener(queryDocumentSnapshots -> {
                    if (!queryDocumentSnapshots.isEmpty()) {
                        ...
                        intent.putExtra("language", "Python"); // Pass language to TestLive
                ...
                .addOnFailureListener(e ->
                        Toast.makeText(ModeratePython.this, "Error loading question: " + e.getMessage(), Toast.LENGTH_LONG).show()
                );
    }
}
