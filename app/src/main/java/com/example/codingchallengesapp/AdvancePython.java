...
public class AdvancePython extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.python_advance);  // Update if using a different layout for Python
    ...
    private void fetchQuestion(int testNumber) {
        ...
        db.collection("questions")
                .whereEqualTo("difficulty", "Hard")
                .whereEqualTo("test_number", testNumber)
                .whereArrayContains("language", "Python")
                .get()
                .addOnSuccessListener(queryDocumentSnapshots -> {
                    if (!queryDocumentSnapshots.isEmpty()) {
                        ...
                        Intent intent = new Intent(AdvancePython.this, TestLive.class);
                        intent.putExtra("title", title);
                        intent.putExtra("question", question);
                        intent.putExtra("language", "Python"); // Important for TestLive
                ...
                .addOnFailureListener(e ->
                        Toast.makeText(AdvancePython.this, "Error loading question: " + e.getMessage(), Toast.LENGTH_LONG).show()
                );
    }
}
