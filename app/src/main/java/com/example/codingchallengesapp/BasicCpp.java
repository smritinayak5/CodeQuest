...
public class BasicCpp extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cpp_basic);  // Layout file with 5 test cards
        ...
        db.collection("questions")
                ...
                .addOnSuccessListener(queryDocumentSnapshots -> {
                    if (!queryDocumentSnapshots.isEmpty()) {
                        ...
                        Intent intent = new Intent(BasicCpp.this, TestLive.class);
                        intent.putExtra("title", title);
                        intent.putExtra("question", question);
                        intent.putExtra("language", "C++"); // Pass language info
                ...
                .addOnFailureListener(e ->
                        Toast.makeText(BasicCpp.this, "Error loading question: " + e.getMessage(), Toast.LENGTH_LONG).show()
                );
    }
}
