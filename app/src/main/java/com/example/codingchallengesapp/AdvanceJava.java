...
public class AdvanceJava extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.java_advance);  // Use R.layout.java_advance if available
        ...
        db.collection("questions")
                ...
                .addOnSuccessListener(queryDocumentSnapshots -> {
                    if (!queryDocumentSnapshots.isEmpty()) {
                        ...
                        Intent intent = new Intent(AdvanceJava.this, TestLive.class);
                ...
                .addOnFailureListener(e ->
                        Toast.makeText(AdvanceJava.this, "Error loading question: " + e.getMessage(), Toast.LENGTH_LONG).show()
                );
    }
}
