...
public class AdvanceCpp extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cpp_advance);  // Use R.layout.cpp_advance if available
        ...
        db.collection("questions")
                ...
                .addOnSuccessListener(queryDocumentSnapshots -> {
                    if (!queryDocumentSnapshots.isEmpty()) {
                        ...
                        Intent intent = new Intent(AdvanceCpp.this, TestLive.class);
                ...
                .addOnFailureListener(e ->
                        Toast.makeText(AdvanceCpp.this, "Error loading question: " + e.getMessage(), Toast.LENGTH_LONG).show()
                );
    }
}
