...
public class BasicPython extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.python_basic);  // Layout file with 5 test cards
        ...
        db.collection("questions")
                ...
                .addOnSuccessListener(queryDocumentSnapshots -> {
                    if (!queryDocumentSnapshots.isEmpty()) {
                        ...
                        Intent intent = new Intent(BasicPython.this, TestLive.class);
                        intent.putExtra("title", title);
                        intent.putExtra("question", question);
                        intent.putExtra("language", "Python"); // Pass the language
                ...
                .addOnFailureListener(e ->
                        Toast.makeText(BasicPython.this, "Error loading question: " + e.getMessage(), Toast.LENGTH_LONG).show()
                );
    }
}
